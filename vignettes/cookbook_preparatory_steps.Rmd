...
imports <- sort(unique(unlist(strsplit(x = imports, split = ",[[:space:]]"))))
...
imports <- paste(
  utils::packageDescription("r2dii.data")[["Suggests"]],
  utils::packageDescription("r2dii.match")[["Suggests"]],
  utils::packageDescription("r2dii.analysis")[["Suggests"]],
  utils::packageDescription("r2dii.plot")[["Suggests"]],
  sep = ", "
)
imports <- sort(unique(unlist(strsplit(x = imports, split = ",[[:space:]]"))))
cat(paste0("`", paste0(imports, collapse = "`, `"), "`"))
...
- [ ] Installed the required R packages:
  - [ ] `r2dii.*` suite of R packages dependencies
- [ ] OPTIONAL - Installed the suggested R packages:
  - [ ] `r2dii.*` suite of R packages suggests
