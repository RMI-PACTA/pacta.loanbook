...
cat(paste0("- `", names(abcd_demo), "`", collapse = "\n"))
```
...
cat(paste0("- `", names(scenario_demo_2020), "`", collapse = "\n"))
```
...
cat(paste0("- `", names(co2_intensity_scenario_demo), "`", collapse = "\n"))
```
...
cat(paste0("- `", names(loanbook_demo), "`", collapse = "\n"))
```
...
cat(paste0("- `", names(sector_classifications), "`", collapse = "\n"))
```
