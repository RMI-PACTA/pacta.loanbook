...
list_col_names_and_types(abcd_demo)
```
...
list_col_names_and_types(scenario_demo_2020)
```
...
list_col_names_and_types(co2_intensity_scenario_demo)
```
...
list_col_names_and_types(loanbook_demo)
```
