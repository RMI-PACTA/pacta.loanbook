...
```{r use_case_three_risk_mangement_result, warning = FALSE}
# misaligned_coal
table_misaligned_coal <- gt::gt(misaligned_coal)

table_misaligned_coal <-
  gt::cols_width(
    .data = table_misaligned_coal,
    year ~ gt::px(100),
    projected ~ gt::px(100),
    target_sds ~ gt::px(100),
    deviation ~ gt::px(100)
  )
...
table_misaligned_coal <-
  gt::tab_style(
    ...
    locations = gt::cells_body(columns = 1:3)
  )
...
table_misaligned_coal <- gt::fmt_passthrough(table_misaligned_coal)

table_misaligned_coal

# misaligned_cement
table_misaligned_cement <- gt::gt(misaligned_cement)

table_misaligned_cement <-
  gt::cols_width(
    .data = table_misaligned_cement,
    year ~ gt::px(100),
    projected ~ gt::px(100),
    target_demo ~ gt::px(100),
    deviation ~ gt::px(100)
  )
...
table_misaligned_cement <- gt::fmt_passthrough(table_misaligned_cement)
