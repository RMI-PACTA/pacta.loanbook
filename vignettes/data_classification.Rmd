...
The `{r2dii.data}` package provides a sector classification dataset `r2dii.data::sector_classifications` that contains a sector mapping for all supported sector classification systems (`{r unique(r2dii.data::sector_classifications$code_system)}`).
