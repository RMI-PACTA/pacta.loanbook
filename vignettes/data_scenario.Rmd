...
The `{r2dii.data}` package provides an example climate transition scenario dataset `r2dii.data::scenario_demo_2020`.
...
The `{r2dii.data}` package provides an example CO^2^ intensity climate transition scenario dataset `r2dii.data::co2_intensity_scenario_demo`.
