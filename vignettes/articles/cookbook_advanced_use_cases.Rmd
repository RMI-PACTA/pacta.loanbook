...
```{r share_table_data_prep, echo = FALSE, warning = FALSE}
coal_share <- sum(filter(tech_mix_sector_targets, technology == "coalcap")$technology_share, na.rm = TRUE)
gas_share <- sum(filter(tech_mix_sector_targets, technology == "gascap")$technology_share, na.rm = TRUE)
oil_share <- sum(filter(tech_mix_sector_targets, technology == "oilcap")$technology_share, na.rm = TRUE)
renewable_share <- sum(filter(tech_mix_sector_targets, technology == "renewablescap")$technology_share, na.rm = TRUE)
hydro_share <- sum(filter(tech_mix_sector_targets, technology == "hydrocap")$technology_share, na.rm = TRUE)
```

|                                  |                            |
|----------------------------------|---------------------------:|
| share of coal-fired power plants | `r coal_share * 100`%      |
| share of gas-fired power         | `r gas_share * 100`%       |
| share of oil-fired power         | `r oil_share * 100`%       |
| share of renewable power         | `r renewable_share * 100`% |
| share of hydro power             | `r hydro_share * 100`%     |
