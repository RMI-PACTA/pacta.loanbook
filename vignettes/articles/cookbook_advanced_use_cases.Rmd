...
Suppose you have a loanbook containing a loan to the power company "Acme Co.". information on "Acme Co." from a different source.
...
You could now read in this XLSX file, merge the imported data with my existing ABCD data by adding the rows to the bottom of the ABCD table, and with the combined ABCD, you can now get a matched loan, when re-running the matching process.
