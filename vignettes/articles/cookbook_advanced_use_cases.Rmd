...
Regulators typically focus on the overall loan book rather than individual clients, allowing financial institutions to determine client-specific reporting. Regulations generally apply to the structure of the loan book, making portfolio-level PACTA analysis the most appropriate depth of analysis for this use case.
...
- Type of climate metrics (e.g. absolute emissions, financed emissions, production-based emission intensity, production volumes)
- Scope and granularity (e.g., aggregated loan book exposures, climate-relevant sector exposures, or sector-specific reporting)
