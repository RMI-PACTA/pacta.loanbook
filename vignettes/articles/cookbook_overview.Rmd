...
PACTA for Banks is primarily designed for banks to run independently with no or limited support from RMI. However, it can also be useful for others interested in conducting a transition assessment on a loan book.
