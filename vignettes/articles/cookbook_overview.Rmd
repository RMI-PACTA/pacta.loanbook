...
This cookbook is produced with funding support from the government of Japan through the IFC’s climate risk management advisory program.
...
PACTA for Banks is primarily designed for banks to run independently with no or limited support from RMI. However, it can also be useful for others interested in conducting a transition assessment on their loan books. If you are interested in comparing multiple loanbooks at the same time, check out the `{pacta.multi.loanbook}` package.
